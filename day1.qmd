...
df <- df |>
  ...
  mutate(boy = gender==1 & age<15, # <2>
    girl = gender==2 & age<15,
    prime_aged_male = gender==1 & age>=15 & age<=64,
    prime_aged_female = gender==2 & age>=15 & age<=64,
    elderly_male = gender==1 & age>64,
    elderly_female = gender==2 & age>64)
```
